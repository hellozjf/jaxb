...
// 生成时间: 2017.09.29 时间 08:15:38 PM CST 
//


package com.hellozjf.test.jaxb.QcScrapVouch;
 ...
 *       &lt;sequence>
 *         &lt;element name="qcscrapvouch" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                                       &lt;element name="gspstate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class Ufinterface {
    ...
    protected List<Ufinterface.Qcscrapvouch> qcscrapvouch;
    ...
    /**
     * Gets the value of the qcscrapvouch property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the qcscrapvouch property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQcscrapvouch().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Ufinterface.Qcscrapvouch }
     * 
     * 
     */
    public List<Ufinterface.Qcscrapvouch> getQcscrapvouch() {
        if (qcscrapvouch == null) {
            qcscrapvouch = new ArrayList<Ufinterface.Qcscrapvouch>();
        }
        return this.qcscrapvouch;
    }
    ...
    public static class Qcscrapvouch {

        protected List<Ufinterface.Qcscrapvouch.Header> header;
        protected List<Ufinterface.Qcscrapvouch.Body> body;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ufinterface.Qcscrapvouch.Header }
         * 
         * 
         */
        public List<Ufinterface.Qcscrapvouch.Header> getHeader() {
            if (header == null) {
                header = new ArrayList<Ufinterface.Qcscrapvouch.Header>();
            }
            return this.header;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ufinterface.Qcscrapvouch.Body }
         * 
         * 
         */
        public List<Ufinterface.Qcscrapvouch.Body> getBody() {
            if (body == null) {
                body = new ArrayList<Ufinterface.Qcscrapvouch.Body>();
            }
            return this.body;
        }
        ...
        public static class Body {
            ...
            protected List<Ufinterface.Qcscrapvouch.Body.Entry> entry;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Ufinterface.Qcscrapvouch.Body.Entry }
             * 
             * 
             */
            public List<Ufinterface.Qcscrapvouch.Body.Entry> getEntry() {
                if (entry == null) {
                    entry = new ArrayList<Ufinterface.Qcscrapvouch.Body.Entry>();
                }
                return this.entry;
            }
            ...
            public static class Entry {
                 ...
                 *     
                 */
                public void setGspstate(String value) {
                    this.gspstate = value;
                }
