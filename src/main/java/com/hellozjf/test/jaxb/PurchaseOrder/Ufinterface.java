...
public class Ufinterface {
    ...
    protected List<Ufinterface.Purchaseorder> purchaseorder;
     ...
     * {@link Ufinterface.Purchaseorder }
     * 
     * 
     */
    public List<Ufinterface.Purchaseorder> getPurchaseorder() {
        if (purchaseorder == null) {
            purchaseorder = new ArrayList<Ufinterface.Purchaseorder>();
        }
    ...
    public static class Purchaseorder {
        ...
        protected List<Ufinterface.Purchaseorder.Header> header;
        protected List<Ufinterface.Purchaseorder.Body> body;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ufinterface.Purchaseorder.Header }
         * 
         * 
         */
        public List<Ufinterface.Purchaseorder.Header> getHeader() {
            if (header == null) {
                header = new ArrayList<Ufinterface.Purchaseorder.Header>();
            }
            return this.header;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ufinterface.Purchaseorder.Body }
         * 
         * 
         */
        public List<Ufinterface.Purchaseorder.Body> getBody() {
            if (body == null) {
                body = new ArrayList<Ufinterface.Purchaseorder.Body>();
            }
            return this.body;
        }
        ...
        public static class Body {
            ...
            protected List<Ufinterface.Purchaseorder.Body.Entry> entry;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Ufinterface.Purchaseorder.Body.Entry }
             * 
             * 
             */
            public List<Ufinterface.Purchaseorder.Body.Entry> getEntry() {
                if (entry == null) {
                    entry = new ArrayList<Ufinterface.Purchaseorder.Body.Entry>();
                }
                return this.entry;
            }
