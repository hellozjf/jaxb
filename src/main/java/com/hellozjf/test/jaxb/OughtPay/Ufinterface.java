...
// 生成时间: 2017.09.29 时间 08:15:30 PM CST 
//


package com.hellozjf.test.jaxb.OughtPay;
 ...
 *       &lt;sequence>
 *         &lt;element name="oughtpay" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class Ufinterface {
    ...
    protected List<Ufinterface.Oughtpay> oughtpay;
    ...
    /**
     * Gets the value of the oughtpay property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the oughtpay property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOughtpay().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Ufinterface.Oughtpay }
     * 
     * 
     */
    public List<Ufinterface.Oughtpay> getOughtpay() {
        if (oughtpay == null) {
            oughtpay = new ArrayList<Ufinterface.Oughtpay>();
        }
    ...
    public static class Oughtpay {

        protected List<Ufinterface.Oughtpay.Header> header;
        protected List<Ufinterface.Oughtpay.Body> body;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ufinterface.Oughtpay.Header }
         * 
         * 
         */
        public List<Ufinterface.Oughtpay.Header> getHeader() {
            if (header == null) {
                header = new ArrayList<Ufinterface.Oughtpay.Header>();
            }
            return this.header;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ufinterface.Oughtpay.Body }
         * 
         * 
         */
        public List<Ufinterface.Oughtpay.Body> getBody() {
            if (body == null) {
                body = new ArrayList<Ufinterface.Oughtpay.Body>();
            }
            return this.body;
        }
        ...
        public static class Body {
            ...
            protected List<Ufinterface.Oughtpay.Body.Entry> entry;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Ufinterface.Oughtpay.Body.Entry }
             * 
             * 
             */
            public List<Ufinterface.Oughtpay.Body.Entry> getEntry() {
                if (entry == null) {
                    entry = new ArrayList<Ufinterface.Oughtpay.Body.Entry>();
                }
                return this.entry;
            }
